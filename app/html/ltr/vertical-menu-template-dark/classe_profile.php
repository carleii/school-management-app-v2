                                    ...
                                    <div class="card-body px-0">
                                        <ul class="nav user-profile-nav justify-content-center justify-content-md-start nav-tabs border-bottom-0 mb-0"
                                            ...
                                            <li class="nav-item pb-0">
                                                <a class=" nav-link d-flex px-1 " id="feed-tab" data-toggle="tab"
                                                    href="#feed" aria-controls="feed" role="tab" aria-selected="true"><i
                                                        class="bx bx-home"></i><span class="d-none d-md-block">Notes
                                                        Reports</span></a>
                                            </li>
                                            <li class="nav-item pb-0">
                                            ...
                                            <li class="nav-item pb-0">
                                                <a class="nav-link d-flex px-1" id="profile-tab" data-toggle="tab"
                                                    ...
                                                    aria-selected="false"><i class="bx bx-copy-alt"></i><span
                                                        class="d-none d-md-block">Time Table</span></a>
                                            </li>
                                            <li class="nav-item pb-0">
                                            ...
                                            <li class="nav-item pb-0">
                                                <a class="nav-link d-flex px-1" id="activity-tab" data-toggle="tab"
                                                    ...
                                                    aria-selected="false"><i class="bx bx-message-alt"></i><span
                                                        class="d-none d-md-block">Courses</span></a>
                                            </li>
                                            ...
                                            <li class="nav-item pb-0">
                                                <a class="nav-link d-flex px-1" id="compta-tab" data-toggle="tab"
                                                    href="#tuition" aria-controls="tuition" role="tab"
                                                    aria-selected="false"><i class="bx bx-message-alt"></i><span
                                                        class="d-none d-md-block">Class Stats</span></a>
                                            </li>
                                                    ...
                                                    <div class="card-content">
                                                        <div class="card-body">
                                                            <form action="" method="post">
                                                                ...
                                                                <h3>TOTAL AMOUNT TO PAID IN THE SPECIALITY:
                                                                                                                            ...
                                                                                                                            <select
                                                                                                                                ...
                                                                                                                                <optgroup
                                                                                                                                    ...
                                                                                                                                    <?php
                                                                                                                                        ...
                                                                                                                                        ?>
                                                                                                                                    <option
                                                                                                                                        value="<?php echo $result_['code_discipline'] ?>">
                                                                ...
                                                                <form action="" method="post">
                                                                    ...
                                                                    <ul class="widget-timeline">
                                                                        ...
                                                                        <li
                                                                            ...
                                                                            <p class="timeline-text">
                                                                                <button type="submit"
                                                                                    name="delete_dis_class"
                                                                                    value="<?php echo $result['code_discipline']; ?>"
                                                                                    class="btn btn-icon action-icon">
                                                                    ...
                                                                    <ul class="widget-timeline">
                                                                        ...
                                                                        <li
                                                                            ...
                                                                            <p class="timeline-text">
                                                                                ...
                                                                                For <a
                                                                                    href="JavaScript:void(0);"><?php echo "Date: " . $result['echeance']; ?></a>
                                                                            </p>
                                                                            <div class="timeline-content">
                                                                            </div>
                                                                        </li>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <button type="submit"
                                                                                                name="delete_student"
                                                                                                value="<?php echo $result['matricule_apprenant']; ?>"
                                                                                                class="btn btn-icon action-icon">
                                                                                                <span
                                                                                                    class="fonticon-wrap">
                                                                                                    <i class="livicon-evo"
                                        ...
                                        <div class="tab-pane" id="profile" aria-labelledby="profile-tab"
                                                                    ...
                                                                    <div class="col-md-8 form-group">
                                                                        <div class="mb-3">
                                                                            <fieldset
                                                                                ...
                                                                                <input type="text"
                                                                                    class="form-control drops" required
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <fieldset
                                                                                ...
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    ?>
                                                                                    <option
                                                                                        value="<?php echo $result['nom_salle']; ?>">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <fieldset
                                                                                ...
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    <option
                                                                                        value="<?php echo $code_discipline ?>">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    ...
                                                    <a href="print_time_table.php?ktsp=<?php echo $week_view . "." . $code_classe; ?> "
                                                        target="_blank"><button name="print_time_table"
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <form class="form form-horizontal" method="post"
                                                        action="print_b_spe.php?ktsp=<?php echo base64_encode($code_classe) ?>"
                                                        target="_blank">
                                                        <div class="card-body card-dashboard">
                                                            <div class="form-body">
                                                                <div class="row">
                                                                                                                                        ...
                                                                                                                                        <tbody>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td
                                                                                                                                                    ...
                                                                                                                                                    <input
                                                                                                                                                        type="checkbox"
                                                                                                                                                        name="<?php echo $code_discipline ?>s1"
                                                                                                                                                        id="<?php echo $code_discipline ?>s1"
                                                                                                                                                        value="<?php echo $code_discipline ?>s1">
                                                                                                                                                    <label
                                                                                                                                                        for="<?php echo $code_discipline ?>s1"><?php echo  $nom_discipline; ?></label>
                                                                                                                                        ...
                                                                                                                                        <tbody>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td
                                                                                                                                                    ...
                                                                                                                                                    <input
                                                                                                                                                        type="checkbox"
                                                                                                                                                        name="<?php echo $code_discipline ?>s2"
                                                                                                                                                        id="<?php echo $code_discipline ?>s2"
                                                                                                                                                        value="<?php echo $code_discipline ?>s2">
                                                                                                                                                    <label
                                                                                                                                                        for="<?php echo $code_discipline ?>s2"><?php echo  $nom_discipline; ?></label>
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <?php
                                                                                                                                                    // code...
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <fieldset
                                                                                ...
                                                                                <select required class="form-control"
                                                                                    ...
                                                                                    while ($result = mysqli_fetch_assoc($query)) { ?>
                                                                                    <option
                                                                                        value="<?php echo addslashes($result['code_examen']); ?>">
                                                                ...
                                                                <button type="submit" name="print_note"
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <div class="form-group row">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    id="user-post-textarea"
                                                                                                    rows="3"
                                                                                                    placeholder="<?php echo $nom_classe ?>"
                                                                                                    value="<?php echo $nom_classe ?>"></input>
                                                                                                <label>TUITION
                                                                                                    FEES</label>
                                                                                                <input type="text"
                                                                                                    name="tuition"
                                                                                                    ...
                                                                                                    id="user-post-textarea"
                                                                                                    rows="3"
                                                                                                    placeholder="<?php echo $scolarite ?>"
                                                                                                    value="<?php echo $scolarite ?>"></input>
                                                                                                <label>E-learning
                                                                                                    Password</label>
                                                                                                <input type="text"
                                                                                                    name="password"
                                                                                                    ...
                                                                                                    id="user-post-textarea"
                                                                                                    rows="3"
                                                                                                    placeholder="<?php echo $code_cloud ?>"
                                                                                                    value="<?php echo $code_cloud ?>"></input>
                                                                                                <label>Initial</label>
                                                                                                <input type="text"
                                                                                                    name="init"
                                                                                                    class="form-control border-1 shadow-none"
                                                                                                    id="user-post-textarea"
                                                                                                    rows="3"
                                                                                                    placeholder="<?php echo $ini ?>"
                                                                                                    value="<?php echo $ini ?>"></input>
                                                                                            </div>
                                                                                            <button type="reset"
                                                                                                class="btn btn-light-secondary">
                                                                                                <i
                                                                                ...
                                                                                <div class="card-content">
                                                                                    <div class="card-body">
                                                                                        <h5>CHANGE THE LEVEL OF THIS
                                                                                            SPECIALITY</h5><sup>* <b>all
                                                                                                the student of this
                                                                                                speciality will change
                                                                                                their level</b></sup>
                                                                                        <form class="form" method="post"
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <button
                                                                                                    ...
                                                                                                    type="submit"
                                                                                                    name="change_level">Change</button>
                                                                                            </div>
                                                                                        </form>
                                                                                    </div>
                                                                                </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="media d-flex align-items-center mb-1">
                                                    <a href="JavaScript:void(0);">
                                                        <img src="logo_data/<?php echo $logo ?>" class="rounded"
                                                            alt="group image" height="64" width="64" />
                                                    </a>
                                                    <div class="media-body ml-1">
                                                        <h4 class="media-heading mb-0"><small><a
                                                                    href="classe_profile.php?ktsp=<?php echo base64_encode($result['id']) ?>"><?php echo $result['nom_classe']; ?></a></small>
                                                        </h4>
                                                        <?php echo $niveau ?>
                                                    </div>
                                                </div>
