            ...
            case 0: ?>
                <div class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto;">
                    <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                        ...
                        <div class="swal2-content">
                            <div id="swal2-content" style="display: block;"><?php echo 'The student class have not been updated, please try in few minutes'; ?></div>
                            <input class="swal2-input" style="display: none;">
                            <input type="file" class="swal2-file" style="display: none;">
                            <div class="swal2-range" style="display: none;">
                                <input type="range"><output></output>
            ...
            case 0: ?>
                <div class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto;">
                    <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                        ...
                        <div class="swal2-content">
                            <div id="swal2-content" style="display: block;"><?php echo 'Something went wrong please try in few minutes'; ?></div>
                            <input class="swal2-input" style="display: none;">
                            <input type="file" class="swal2-file" style="display: none;">
                            <div class="swal2-range" style="display: none;">
                                <input type="range"><output></output>
                            ...
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="user-profile-text">
                                        <h4 class="mb-0 text-bold-500 profile-text-color"><?php echo $nom_apprenant . " " . $prenom_apprenant ?></h4>
                                        <small>##############################</small>
                                                                                        ...
                                                                                        <div class="col-sm-11 col-10">
                                                                                            ...
                                                                                            <select name="id_tranche" required class="form-control border-0 shadow-none" id="user-post-textarea" rows="3">
                                                                                                ...
                                                                                                while ($result = mysqli_fetch_assoc($query)) { ?>
                                                                                                    ...
                                                                                                    <option value="<?php echo $result['id']; ?>"><?php echo $result['nom_tranche'] . " :" . $result['montant'] . " USD /" . $result['echeance']; ?></option>
                                                        ...
                                                        <div class="card-body">
                                                            <form action="" method="post" class="wizard-vertical">
                                                                ...
                                                                <select name="exam_code" required id="" class="form-control">
                                                                    ...
                                                                    while ($result = mysqli_fetch_assoc($query)) { ?>
                                                                        <option value="<?php echo $result['code_examen'] ?>"><?php echo $result['nom_examen'] . "  " . $result['periode'] ?></option>
                                                                    <?php
                                                                        # code...
                                                                    }
                                                                    ...
                                                                    <div class="col-12 col-sm-9">
                                                                        <div class="row">
                                                                            <div class="col-12 text-center text-sm-left">
                                                                                <h6 class="media-heading mb-0"><?php echo $prenom_apprenant; ?><i class="cursor-pointer bx bxs-star text-warning ml-50 align-middle"></i></h6>
                                                                                <small class="text-muted align-top"><?php echo $nom_apprenant; ?></small>
                                                                            </div>
                                                                            <div class="col-12 text-center text-sm-left">
                                                                                <div class="mb-1">
                                                                                    <span class="mr-1"><?php echo $matricule_apprenant ?> <small></small></span>
                                                                                    <span class="mr-1"><?php $query = mysqli_query($database, "SELECT * FROM classe WHERE code_classe = '$code_classe' AND matricule_etablissement = '$matricule_etablissement' AND date_academique = '$date_academique' ");
                                                                                                        $result = mysqli_fetch_assoc($query);
                                                                                                        echo $result['nom_classe']; ?> <small></small></span>
                                                                                    <span class="mr-1"><?php echo $nom_niveau; ?> <small></small></span>
                                                                                </div>
                                                                                <div>
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <h6><small class="text-muted">Family adresse</small></h6>
