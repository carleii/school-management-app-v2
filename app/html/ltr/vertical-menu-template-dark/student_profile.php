...
<body class="vertical-layout vertical-menu-modern dark-layout 2-columns  navbar-sticky footer-static menu-open "
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body px-0">
                                        <ul class="nav user-profile-nav justify-content-center justify-content-md-start nav-tabs border-bottom-0 mb-0"
                                            ...
                                            <li class="nav-item pb-0">
                                                <a class="nav-link d-flex px-1" id="activity-tab" data-toggle="tab"
                                                    ...
                                                    aria-selected="false"><i class="bx bx-user"></i><span
                                                        class="d-none d-md-block">Tuition fees</span></a>
                                            </li>
                                            ...
                                            ?>
                                            <li class="nav-item pb-0">
                                                <a class="nav-link d-flex px-1" id="config-tab" data-toggle="tab"
                                                    href="#config" aria-controls="config" role="tab"
                                                    aria-selected="false"><i class="bx bx-message-alt"></i><span
                                                        class="d-none d-md-block">Config</span></a>
                                            </li>
                                            ...
                                            <li class="nav-item pb-0 mr-0 active">
                                                <a class="nav-link d-flex px-1 active" id="profile-tab"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="tab-content">
                                                                                ...
                                                                                <form action="" method="post">
                                                                                    ...
                                                                                    <div class="card-footer p-0">
                                                                                        <span
                                                                                            ...
                                                                                            <button type="submit"
                                                                                                name="regler_tranche"
                                                                                                class="btn btn-danger">Regler</button>
                                                                                        </span>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                    ...
                                                                    <ul class="widget-timeline">
                                                                        ...
                                                                        <li
                                                                            ...
                                                                            <div class="timeline-time"><span
                                                                                    style="text-transform: uppercase;"><?php echo $result_0['nom_tranche']; ?></span>
                                                                            </div>
                                                                            ...
                                                                            <p class="timeline-text">
                                                                                Amount Paid <a
                                                                                    href="JavaScript:void(0);"><?php echo $result_2['montant']; ?></a>
                                                                            </p>
                                                                            <p class="timeline-text">
                                                                                <button type="submit"
                                                                                    name="delete_tranche"
                                                                                    value="<?php echo $result_2['id']; ?>"
                                                                                ...
                                                                                Paid on <a
                                                                                    href="JavaScript:void(0);"><?php echo "Date: " . $result_2['date_paiement']; ?></a>
                                                                                By <a
                                                                                    href="JavaScript:void(0);"><?php echo $result_2['nom_validateur']; ?></a>
                                                                            </p>
                                                                            <div class="timeline-content">
                                                                                <a href="print_bill.php?ktspp=<?php echo $it ?>"
                                                    ...
                                                    <div class="card-content">
                                                        <div class="card-body">
                                                            <form action="" method="post" class="wizard-vertical">
                                                                ...
                                                                <select name="exam_code" required id=""
                                                                    class="form-control">
                                                                    <?php
                                                                    ...
                                                                    while ($result = mysqli_fetch_assoc($query)) { ?>
                                                                    <option
                                                                        value="<?php echo $result['code_examen'] ?>">
                                                                ...
                                                                <h3>
                                                                    <span class="fonticon-wrap mr-1">
                                                                        <i class="livicon-evo"
                                                                            data-options="name:gear.svg; size: 50px; style:lines; strokeColor:#adb5bd;"></i>
                                                                    </span>
                                                                    <span class="icon-title">
                                                                        <span
                                                                            class="d-block"><?php echo $nom_matiere ?></span>
                                                                    </span>
                                                                </h3>
                                                                <fieldset class="pt-0">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group">
                                                                                <input type="number" min="0" max="20"
                                                                                    name="<?php echo $result_4['code_discipline'] ?>"
                                                                                    class="form-control"
                                                                                    placeholder="<?php echo $nom_discipline ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- step 1 content end-->
                                                                ...
                                                                <button role="menuitem" name='save'
                                                                    class="btn btn-light-primary">Save</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><?php echo $note; ?>
                                                                                            ...
                                                                                            <button type="submit"
                                                                                                name="delete_note"
                                                                                                value="<?php echo $code_discipline . "." . $code_examen ?>"
                                                                                                class="btn btn-icon action-icon">
                                                                                                <span
                                                                                                    class="fonticon-wrap">
                                                                                                    <i class="livicon-evo"
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <div class="form-group row">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    value="<?php echo $nom_apprenant ?>"></input>
                                                                                                <label>Last Name</label>
                                                                                                <input type="text"
                                                                                                    name="prenom_apprenant"
                                                                                                    class="form-control border-1 shadow-none"
                                                                                                    id="user-post-textarea"
                                                                                                    rows="3"
                                                                                                    placeholder="<?php echo $prenom_apprenant ?>"
                                                                                                    value="<?php echo $prenom_apprenant ?>"></input>
                                                                                                <label>Email</label>
                                                                                                <input type="email"
                                                                                                    name="telephone_apprenant"
                                                                                                    class="form-control border-1 shadow-none"
                                                                                                    id="user-post-textarea"
                                                                                                    rows="3"
                                                                                                    placeholder="<?php echo $telephone ?>"
                                                                                                    value="<?php echo $telephone ?>"></input>
                                                                                                <label>Birthday and
                                                                                                    Place</label>
                                                                                                <input type="text"
                                                                                                    name="adresse_apprenant"
                                                                                                    class="form-control border-1 shadow-none"
                                                                                                    id="user-post-textarea"
                                                                                                    rows="3"
                                                                                                    placeholder="<?php echo $adresse ?>"
                                                                                                    value="<?php echo $adresse ?>"></input>
                                                                                                <label>Others
                                                                                                    informations</label>
                                                                                                <textarea
                                                                                                    name="other_info_apprenant"
                                                                                                    class="form-control border-1 shadow-none"
                                                                                                    id="user-post-textarea"
                                                                                                    rows="3"><?php echo $information_tierce ?> </textarea>
                                                                                                <label>Tutor
                                                                                                    Adresse</label>
                                                                                                <input type="text"
                                                                                                    name="tutor_apprenant"
                                                                                                    class="form-control border-1 shadow-none"
                                                                                                    id="user-post-textarea"
                                                                                                    rows="3"
                                                                                                    placeholder="<?php echo $contact_parentale ?>"
                                                                                                    value="<?php echo $contact_parentale ?>"></input>
                                                                                            </div>
                                                                                            <button type="reset"
                                                                                                ...
                                                                                                <span
                                                                                                    class="d-none d-sm-block">Clean</span>
                                                                                            </button>
                                                                                            <button type="submit"
                                                                                                name="update_student"
                                                                                        ...
                                                                                        <form class="form" method="post"
                                                                                            ...
                                                                                            <div class="form-goup">
                                                                                                <select
                                                                                                    ...
                                                                                                    ?>
                                                                                                    <option
                                                                                                        value="<?php echo $result['code_classe']; ?>">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <button
                                                                                                    ...
                                                                                                    type="submit"
                                                                                                    name="change_class">Change</button>
                                                                                            </div>
                                                                                        </form>
                                                                                    </div>
                                                                                </div>
                                        ...
                                        <div class="tab-pane active" id="profile" aria-labelledby="profile-tab"
                                            role="tabpanel">
                                                                        ...
                                                                        <div class="row">
                                                                            <div
                                                                                ...
                                                                                <h6 class="media-heading mb-0">
                                                                                    <?php echo $prenom_apprenant; ?><i
                                                                                        class="cursor-pointer bx bxs-star text-warning ml-50 align-middle"></i>
                                                                                </h6>
                                                                                <small
                                                                                    class="text-muted align-top"><?php echo $nom_apprenant; ?></small>
                                                                            </div>
                                                                            <div
                                                                                class="col-12 text-center text-sm-left">
                                                                                <div class="mb-1">
                                                                                    <span
                                                                                        class="mr-1"><?php echo $matricule_apprenant ?>
                                                                                        <small></small></span>
                                                                                    <span
                                                                                        class="mr-1"><?php $query = mysqli_query($database, "SELECT * FROM classe WHERE code_classe = '$code_classe' AND matricule_etablissement = '$matricule_etablissement' AND date_academique = '$date_academique' ");
                                                                                                        $result = mysqli_fetch_assoc($query);
                                                                                                        echo $result['nom_classe']; ?>
                                                                                        <small></small></span>
                                                                                    <span
                                                                                        class="mr-1"><?php echo $nom_niveau; ?>
                                                                                        <small></small></span>
                                                                                </div>
                                                                                <div>
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li><i
                                                                    class="cursor-pointer bx bx-map mb-1 mr-50"></i><?php echo $adresse; ?>
                                                            </li>
                                                            <li><i
                                                                    class="cursor-pointer bx bx-phone-call mb-1 mr-50"></i><?php echo $telephone; ?>
                                                            </li>
                                                            <li><i
                                                                    class="cursor-pointer bx bx-time mb-1 mr-50"></i><?php echo $date_academique; ?>
                                                            </li>
                                                        </ul>
                                                        <div class="row">
                                                            <div class="col-6">
